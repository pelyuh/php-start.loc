...
// BEGIN: Урок 8. Задача 2: Использование форм #2

echo '<b>' . 'Задача 2: Использование форм #2' . '</b><br><br>';

echo '<a href="lesson8_task2.php">Click me</a>';

// END: Урок 8. Задача 2: Использование форм #2
